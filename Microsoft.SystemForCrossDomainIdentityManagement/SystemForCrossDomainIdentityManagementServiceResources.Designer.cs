...
namespace Microsoft.SCIM {
    ...
    public class SystemForCrossDomainIdentityManagementServiceResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The SCIM path prefix must be a single non-empty URL segment containing no separator or whitespace..
        /// </summary>
        public static string ExceptionInvalidScimPathPrefix {
            get {
                return ResourceManager.GetString("ExceptionInvalidScimPathPrefix", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The SCIM path prefix is already in use as &apos;{0}&apos; and cannot be changed to &apos;{1}&apos;..
        /// </summary>
        public static string ExceptionScimPathPrefixAlreadyInUseTemplate {
            get {
                return ResourceManager.GetString("ExceptionScimPathPrefixAlreadyInUseTemplate", resourceCulture);
            }
        }
