...
public class SystemForCrossDomainIdentityManagementConfigurationSection : ISystemForCrossDomainIdentityManagementConfiguration
{
    public static ISystemForCrossDomainIdentityManagementConfiguration Instance { get; set; } =
        new SystemForCrossDomainIdentityManagementConfigurationSection();

    public bool AcceptLargeObjects { get; set; } = true;
}
